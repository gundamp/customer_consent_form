...
# You need to create a file named 'credentials.json' with your Google service account credentials
try:
    with open('credentials.json', 'r') as f:
        creds_dict = json.load(f)
    creds = ServiceAccountCredentials.from_json_keyfile_dict(creds_dict, scope)
except FileNotFoundError:
    st.error("Please create a 'credentials.json' file with your Google service account credentials")
    st.stop()
...
try:
    ...
    st.error("Please make sure you have the correct spreadsheet name and permissions")
    st.stop()

# --- For image uploads -----------------------------------------------------
# You need to set your Google Drive folder ID here
FOLDER_ID = "1KirL7ObtYXSifLMNg6GBUa7GR43GcHmY"  # Replace with your actual folder ID
